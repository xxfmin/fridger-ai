...
export default function HeroSection() {
  return (
    <AuroraBackground>
        ...
        >
          <button className="w-35 transform rounded-lg bg-[#0096FF] px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-blue-700">
            Try it now
          </button>
        </motion.div>
